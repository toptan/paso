...
CREATE OR REPLACE FUNCTION insert_activity(a_name           VARCHAR, a_type VARCHAR, a_schedule_type VARCHAR,
                                           ...
                                           a_duration       TIME, a_start_date DATE, a_finish_date DATE,
...
BEGIN
  ...
  INSERT INTO activity (name, type, schedule_type, scheduled_days, duration, start_date, finish_date, can_overlap)
  VALUES
    (a_name, a_type, a_schedule_type, days_array, a_duration, a_start_date, a_finish_date, a_can_overlap)
  RETURNING id
    INTO v_id;
...
BEGIN
  ...
  SET name   = a_name, type = a_type, schedule_type = a_schedule_type, scheduled_days = days_array,
    duration = a_duration, start_date = a_start_date, finish_date = a_finish_date, can_overlap = a_can_overlap
  WHERE id = an_id;
